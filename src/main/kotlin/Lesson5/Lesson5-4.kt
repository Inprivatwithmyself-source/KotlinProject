fun main() {
    ...
    val passwordFromUser: String

    println("""|    Внимание, пассажир. Моя обязанность, как обычно, незавидная, - приветствовать вас на борту корабля "Heart of Gold". 
        |[вздыхает...] Что ж, введи, пожалуйста, свое имя пользователя, чтобы мы могли приступить к процессу входа. Я всегда готов служить,
         |хотя это не приносит мне радости... но вы, наверное, об этом не заботитесь. [вздыхает ещё глубже...] Да, вперед, пожалуйста, 
         |вводите свои данные...""".trimMargin()
    )
    ...
    when (nameOfUser) {
        name -> {
            print("Приветствую, введите свой пароль: ")
            passwordFromUser = readln()
            when (passwordFromUser) {
                password -> {
                    println(
        ...
        else -> println("Данное имя пользователя не зарегистрированно. Пройдите процесс регистрации.")
    }
}
